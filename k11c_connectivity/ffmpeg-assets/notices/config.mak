...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/opt/k11c-ffmpeg --arch=aarch64 --target-os=linux --enable-cross-compile --cross-prefix=aarch64-linux-gnu- --pkg-config=pkg-config --disable-autodetect --disable-doc --disable-debug --disable-ffplay --enable-gpl --enable-version3 --enable-libdrm --enable-libudev --enable-v4l2-request --enable-libx264 --enable-openssl --enable-zlib --enable-bzlib --enable-lzma --disable-shared --enable-static --extra-version=k11c-vpu-r1-fad85d9
prefix=/opt/k11c-ffmpeg
...
NM_CMD=aarch64-linux-gnu-nm -g
METALCC=xcrun -sdk macosx metal
METALLIB=xcrun -sdk macosx metallib
RANLIB=aarch64-linux-gnu-ranlib -D
...
SLIBSUF=.so
EXESUF=
EXTRA_VERSION=k11c-vpu-r1-fad85d9
CCDEP=
CXXDEP=
CCDEP_FLAGS=
ASDEP=
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-lm -latomic -L/usr/lib/aarch64-linux-gnu -ldrm
EXTRALIBS-avfilter=-pthread -lm -latomic
EXTRALIBS-swscale=-lm -latomic
EXTRALIBS-postproc=-lm -latomic
EXTRALIBS-avformat=-lm -latomic -lbz2 -L/usr/lib/aarch64-linux-gnu -lz -L/usr/lib/aarch64-linux-gnu -lssl -lcrypto
EXTRALIBS-avcodec=-pthread -lm -latomic -llzma -L/usr/lib/aarch64-linux-gnu -lx264 -L/usr/lib/aarch64-linux-gnu -ludev -L/usr/lib/aarch64-linux-gnu -lz -L/usr/lib/aarch64-linux-gnu -ldrm -L/usr/lib/aarch64-linux-gnu -ludev
EXTRALIBS-swresample=-lm -latomic
EXTRALIBS-avutil=-pthread -L/usr/lib/aarch64-linux-gnu -ludev -lm -L/usr/lib/aarch64-linux-gnu -lssl -lcrypto -latomic -L/usr/lib/aarch64-linux-gnu -ldrm -L/usr/lib/aarch64-linux-gnu -ludev
EXTRALIBS-ffplay=
EXTRALIBS-ffprobe=
EXTRALIBS-ffmpeg=
EXTRALIBS-cpu_init=-pthread
EXTRALIBS-cws2fws=-L/usr/lib/aarch64-linux-gnu -lz
ARCH_AARCH64=yes
!ARCH_ARM=yes
!ARCH_IA64=yes
!ARCH_LOONGARCH=yes
